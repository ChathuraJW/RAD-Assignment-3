let gpaDistribution = document.getElementById('gpaDistributionCanvas').getContext('2d');
...
let individualGPADistribution = document.getElementById('individualGPADistributionCanvas').getContext('2d');
...
let gradeContribution = document.getElementById('gradeContributionCanvas').getContext('2d');
